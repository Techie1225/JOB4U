		...
		<ul class="navbar-nav mr-auto">
			<c:choose>
				...
				<c:when test="${userobj.role eq 'Admin' }">
					<li class="nav-item active"><a class="nav-link"
						href="admin.jsp"><i class="fas fa-home"></i> Home </a></li>
					...
					<li class="nav-item"><a class="nav-link" href="viewjobs.jsp"><i
							class="fas fa-eye"></i> View Posted Job</a></li>
					<li class="nav-item"><a class="nav-link" href="viewAppliedJobs.jsp"><i
							class="fas fa-eye"></i> View Applicants</a></li>
				</c:when>
				<c:when test="${userobj.role eq 'User' }">
					<li class="nav-item active"><a class="nav-link"
						href="user.jsp"><i class="fas fa-home"></i> Home </a></li>
